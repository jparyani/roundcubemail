...
* First run `docker build -t roundcube .` to build the docker image
* Then you will need to run the image with `docker run -p 33411:33411 --dns='127.0.0.1' -i -t roundcube /sbin/my_init -- /bin/bash`
